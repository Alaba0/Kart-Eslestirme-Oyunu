...
public class Config
{
    ...
    {
        var theTime = System.DateTime.Now.ToString(format: "hh:mm");
        var theData = System.DateTime.Now.ToString(format: "MM/dd/yyyy");
    ...
    {
        System.IO.File.WriteAllText(Path, contents: string.Empty);
